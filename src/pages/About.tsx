    ...
    <div className="d-flex flex-column min-vh-100">
      ...
      <div
        ...
        style={{
          height: "400px",
          backgroundImage:
            'linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url("https://images.unsplash.com/photo-1559339352-11d035aa65de?auto=format&fit=crop&w=1920&q=80")',
      ...
      >
        <div className="container text-white" style={{ zIndex: 2 }}>
          <span className="badge bg-warning text-dark mb-3 text-uppercase fw-bold ls-1 px-3 py-2">
            Our Story
          </span>
          <h1 className="display-3 fw-bold font-playfair mb-3">
            About SaiGourmet
          </h1>
          <p className="lead opacity-90 fs-4">
            Connecting food lovers with the soul of Saigon's culinary scene.
          </p>
        </div>
      </div>
          ...
          <div className="row align-items-center g-5">
            <div className="col-lg-6">
              <div className="position-relative">
                <img
                  src="https://images.unsplash.com/photo-1695606452735-a161ad7217d1?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="Dining Experience"
                  className="img-fluid rounded-3 shadow-lg"
                />
                <div
                  className="position-absolute bottom-0 start-0 bg-white p-4 rounded-3 shadow-lg m-4 d-none d-md-block"
                  style={{ borderLeft: "5px solid #b2744c" }}
                >
                  <h5 className="fw-bold font-playfair m-0">
            ...
            <div className="col-lg-6">
              ...
              <h2 className="display-5 fw-bold font-playfair mb-4 mt-2">
                We simplified dining <br />{" "}
                <span style={{ color: "#b2744c" }}>reservations.</span>
              </h2>
              <p className="text-secondary fs-5" style={{ lineHeight: "1.8" }}>
                Founded in 2025, SaiGourmet was born from a simple frustration:
                finding a great table in Saigon was harder than it should be.
              </p>
              <p className="text-muted mb-4">
                Ho Chi Minh City is a culinary paradise, from street-side
                plastic stools to Michelin-star fine dining. Our mission is to
                bridge the gap between hungry diners and the amazing restaurants
                that feed this city.
              </p>
      ...
      <section className="py-5 bg-light">
        <div className="container py-4">
          <div className="text-center mb-5">
            ...
            <h2 className="fw-bold display-6 font-playfair mt-2">
              Our Core Values
            </h2>
            <div
              className="mx-auto mt-3"
              style={{ width: "60px", height: "3px", background: "#b2744c" }}
            ></div>
          </div>
          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm p-4 text-center hover-scale">
                ...
                <p className="text-muted">
                  We don't just list restaurants; we celebrate them. Every venue
                  on SaiGourmet is vetted for quality.
                </p>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm p-4 text-center hover-scale">
                ...
                <p className="text-muted">
                  We believe dining is about connection. We build features that
            ...
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm p-4 text-center hover-scale">
                ...
                <p className="text-muted">
                  From our app design to our customer support, we strive for a
      ...
      <section className="py-5 bg-white">
        <div className="container text-center py-4">
          <h2 className="display-6 fw-bold font-playfair mb-4">
            Ready to taste the best of Saigon?
          </h2>
          <div className="d-flex justify-content-center gap-3">
            ...
            <Link
              to="/contact"
              className="btn btn-outline-dark btn-lg rounded-pill px-5 py-3 fw-bold"
            >
              Contact Us
            </Link>
          </div>
