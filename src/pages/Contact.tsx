  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setModalConfig({
        ...
        button: "Okay",
        onConfirm: closeModal, // Just close the modal, stay on page
      });
    }, 1500);
  };
    ...
    <div className="d-flex flex-column min-vh-100 bg-light">
      ...
      <div
        ...
        style={{
          height: "350px",
          backgroundImage:
            'linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url("https://images.unsplash.com/photo-1423666639041-f56000c27a9a?auto=format&fit=crop&w=1920&q=80")',
      ...
      >
        <div className="container text-white" style={{ zIndex: 2 }}>
          ...
          <p className="lead opacity-90 fs-4">
            Questions? Partnership inquiries? We're here to help.
          </p>
        </div>
      </div>

      <div
        className="container py-5 mt-n5"
        style={{ marginTop: "-50px", position: "relative", zIndex: 5 }}
      >
        {/* --- INFO CARDS --- */}
          ...
          <div className="col-md-4">
            <div className="card border-0 shadow-sm h-100 text-center py-4 hover-scale">
              <div className="card-body">
                ...
                >
                  <i
                    className="fa fa-map-marker fs-3"
                    style={{ color: "#b2744c" }}
                  ></i>
                </div>
          ...
          <div className="col-md-4">
            <div className="card border-0 shadow-sm h-100 text-center py-4 hover-scale">
              <div className="card-body">
                ...
                >
                  <i
                    className="fa fa-envelope fs-3"
                    style={{ color: "#b2744c" }}
                  ></i>
                </div>
                <h5 className="fw-bold font-playfair">Email Us</h5>
                <p className="text-muted small mb-0">
                  support@saigourmet.com
                  <br />
                  partners@saigourmet.com
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-7">
            <div className="card border-0 shadow-lg h-100">
              <div className="card-body p-5">
                <h3 className="fw-bold font-playfair mb-4">
                  Send us a message
                </h3>
