    ...
    const mockArticles: Article[] = [
      {
        ...
        content:
          "Discover the quiet corners of Saigon's bustling District 1 where coffee culture thrives away from the noise. We explore vintage cafes hidden in old apartment blocks...",
      },
      {
        articleId: 102,
        ...
        content:
          "From Banh Mi to Pho, explore the culinary heritage of Vietnam through its streets. We list the must-try stalls that have been serving for generations.",
      },
      {
        articleId: 103,
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1599719455360-ff0be7c4dd06?q=80&w=1149&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        content:
