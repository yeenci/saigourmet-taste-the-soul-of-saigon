...
const MOCK_DATA: ExtendedRestaurant[] = [
    ...
    },
    {
        ...
        district: "District 1",
        picture: "https://images.unsplash.com/photo-1550966871-3ed3c47e2ce2?auto=format&fit=crop&w=500&q=60",
        rating: 4.9,
        openTime: "17:30",
        closeTime: "23:00",
    ...
    },
    {
        ...
        district: "District 1",
        picture: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=500&q=60",
        rating: 4.6,
        openTime: "07:30",
        closeTime: "23:00",
                ...
                <div className="container py-5">
                    <div className="row align-items-center">
                        <div className="col-md-6">
                            <h1 className="fw-bold font-playfair display-5 mb-2">Find your table</h1>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-3 mb-4">
                        <div className="card border-0 shadow-sm p-3 position-sticky" style={{top: '100px'}}>
                            <h5 className="fw-bold mb-3"><i className="fa fa-sliders me-2"></i>Filters</h5>
                            
                            <div className="mb-4">
                                <label className="form-label fw-bold small text-muted text-uppercase">District</label>
                                <select 
                        ...
                        {loading ? (
                                                ...
                                                <div className="card-body d-flex flex-column p-4">
                                                    ...
                                                    <div className="mb-2">
                                                        {restaurant.categories.slice(0, 3).map((cat, idx) => (
                                                            <span key={idx} className="badge bg-light text-secondary me-1 border">{cat}</span>
                                                        ))}
                                                    </div>
                            ...
                            <div className="text-center py-5">
                                ...
                                <button 
                                    ...
                                    onClick={() => {setSearchTerm(""); setFilterDistrict("All"); setFilterCategory("All");}}
                                >
                                    Clear all filters
                                </button>
                            </div>
